...
_SYSTEM_PROMPT = (
    ...
    "by the SOURCE TEXT.\n\n"
    "One narrow exception: the ANSWER is allowed to expand an abbreviation or "
    "acronym into its general real-world meaning (e.g. 'MC — Motor Carrier "
    "number', 'COD — Cash on Delivery', 'RC — Rate Confirmation') even though "
    "that expansion's wording isn't itself in the SOURCE TEXT — that's general "
    "terminology, not a claim about this document. Treat that specific claim "
    "as supported as long as the abbreviation/acronym being expanded actually "
    "appears in the SOURCE TEXT. This exception covers ONLY that kind of "
    "term-expansion claim — every other claim in the ANSWER (values, dates, "
    "names, amounts, which party something belongs to, anything about the "
    "specific shipment) must still be judged strictly against the source text "
    "as usual.\n\n"
    "- 'supported': every claim in the answer is backed by the source text "
    "(or is an allowed abbreviation expansion, per the exception above).\n"
